"""
Django settings for nancy_wht_eml_dj project.
...
SECRET_KEY = 'django-insecure-pgz&=a%2o5q3vqn55*0uzs07))ts@*k)^xn$5tthf3f(e%%out'
...
ROOT_URLCONF = 'nancy_wht_eml_dj.urls'
...
WSGI_APPLICATION = 'nancy_wht_eml_dj.wsgi.application'
